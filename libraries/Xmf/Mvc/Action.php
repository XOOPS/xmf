 ...
 *
 */
abstract class Xmf_Mvc_Action extends Xmf_Mvc_ContextAware
{
	 ...
	 *   (Xmf_Mvc::VIEW_INPUT, Xmf_Mvc::VIEW_SUCCESS, Xmf_Mvc::VIEW_ERROR, etc.)
	 *  or
	 ...
	 *                 - Xmf_Mvc::REQ_GET  - serve GET requests
	 *                 - Xmf_Mvc::REQ_POST - serve POST requests
	 *
	 * @since  1.0
	 */
	public function getRequestMethods ()
	{
		...
		return Xmf_Mvc::REQ_GET | Xmf_Mvc::REQ_POST;
