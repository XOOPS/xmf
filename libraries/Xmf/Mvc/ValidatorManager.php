 ...
 *
 */
class Xmf_Mvc_ValidatorManager extends Xmf_Mvc_ContextAware
{
	 ...
	 *
	 * @param string $name           A parameter name.
	 * @param string $validatorName  The name of the validator class (minus Xmf_Mvc_Validator_)
	 * @param mixed  $initParms      $params for a Xmf_Mvc_Validator::initialize()
	 *
	 * @since  1.0
	 */

	function addValidation($name, $validatorName, $initParms=null)
	{
		$validatorClass = 'Xmf_Mvc_Validator_'.$validatorName;
