...
Code must run on PHP 7.4 through 8.4. Do not use features exclusive to PHP 8.0+ (named arguments, match expressions, union type hints in signatures, enums, fibers, readonly properties).
...
3. Tests pass on all supported PHP versions (7.4-8.4).
